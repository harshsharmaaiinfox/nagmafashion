  ...
  template: `
    <div class="seo-example-container">
      ...
      <app-seo-heading 
        ...
        description="Discover new season shirts jackets suits denim and more at Nagma Fashion. Premium quality fast shipping across India COD and easy returns."
        level="1"
...
export class SeoExampleComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.setSEOData({
      title: 'Nagma Fashion Premium Mens and Womens Fashion Online',
      description: 'Discover new season shirts jackets suits denim and more at Nagma Fashion. Premium quality fast shipping across India COD and easy returns.',
      keywords: 'activewear, gym wear, joggers, men\'s clothes, women\'s clothes, stylish outfits, comfort fit, performance clothing, Nagma Fashion',
    ...
    this.seoService.setBreadcrumbStructuredData([
      { name: 'Home', url: 'https://nagmafashion.in' },
      { name: 'Featured Products', url: 'https://nagmafashion.in/featured' }
    ]);
  }
} 
